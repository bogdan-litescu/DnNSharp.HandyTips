/*
 * @name BeautyTips
 * @desc a tooltips/baloon-help plugin for avt_jQuery_1_3_2_ht1
 *
 * @author Jeff Robbins - Lullabot - http://www.lullabot.com
 * @version 0.9.5 release candidate 1  (5/20/2009)
 */
 
avt_jQuery_1_3_2_ht1.bt = {version: '0.9.5-rc1'};
 
/*
 * @type avt_jQuery_1_3_2_ht1
 * @cat Plugins/bt
 * @requires avt_jQuery_1_3_2_ht1 v1.2+ (not tested on versions prior to 1.2.6)
 *
...
;(function($) { 
   ...
   *    (http://plugins.learningavt_jQuery_1_3_2_ht1.com/cluetip/), which in turn was inspired
   *    by Cody Lindley's jTip (http://www.codylindley.com)
   *
   * @fileoverview
   * Beauty Tips is a avt_jQuery_1_3_2_ht1 tooltips plugin which uses the canvas drawing element
   ...
   * http://plugins.avt_jQuery_1_3_2_ht1.com/project/bgiframe - BeautyTips will automatically
   * recognize it and use it.
   *
   * BeautyTips also works with the hoverIntent plugin
   * http://cherne.net/brian/resources/avt_jQuery_1_3_2_ht1.hoverIntent.html
  ...
  avt_jQuery_1_3_2_ht1.fn.bt = function(content, options) {
    ...
    if (avt_jQuery_1_3_2_ht1.fn.hoverIntent && avt_jQuery_1_3_2_ht1.bt.defaults.trigger == 'hover') {
      avt_jQuery_1_3_2_ht1.bt.defaults.trigger = 'hoverIntent';
    }
  
    return this.each(function(index) {
  
      var opts = avt_jQuery_1_3_2_ht1.extend(false, avt_jQuery_1_3_2_ht1.bt.defaults, avt_jQuery_1_3_2_ht1.bt.options, options);
      ...
      this.btOn = function () {
        ...
        // turn off other tips
        $(avt_jQuery_1_3_2_ht1.bt.vars.closeWhenOpenStack).btOff();
        ...
        if (opts.ajaxPath != null && content == false) {
          ...
          if (typeof cacheData == 'string') {
            ...
            // set up the options
            var ajaxOpts = avt_jQuery_1_3_2_ht1.extend(false,
            {
              type: opts.ajaxType,
              data: opts.ajaxData,
            ...
            // do the ajax request
            avt_jQuery_1_3_2_ht1.ajax(ajaxOpts);
        ...
        if (opts.shadow && !shadowSupport()) {
          ...
          avt_jQuery_1_3_2_ht1.extend(opts, opts.noShadowOpts);
        }
        ...
        // http://plugins.avt_jQuery_1_3_2_ht1.com/project/bgiframe
        if (avt_jQuery_1_3_2_ht1.fn.bgiframe) {
          $text.bgiframe();
          $box.bgiframe();  
        }
        ...
        var horiz = left + ((width - textOutWidth) * .5) + parseInt(opts.offsetX);
        // vertical (top) offset for the box
        var vert = top + ((height - textOutHeight) * .5) + parseInt(opts.offsetY);
        ...
        switch(position) {
          ...
          case 'bottom':
            ...
            textBottom = textTop + $text.outerHeight();
            textCenter = {x: textLeft + ($text.btOuterWidth()*opts.centerPointX), y: textTop + ($text.outerHeight()*opts.centerPointY)};
            points[points.length] = spikePoint = {x: ((textRight-textLeft) * .5) + xShift - parseInt(opts.offsetX), y: shadowShiftY - parseInt(opts.offsetY), type: 'spike'};
        ...
        if (opts.clickAnywhereToClose) {
          avt_jQuery_1_3_2_ht1.bt.vars.clickAnywhereStack.push(this);
          $(document).click(avt_jQuery_1_3_2_ht1.bt.docClick);
        }
        
        // stick this element into the closeWhenOthersOpen stack
        if (opts.closeWhenOthersOpen) {
          avt_jQuery_1_3_2_ht1.bt.vars.closeWhenOpenStack.push(this);
        }
      ...
      this.btOff = function() {
        ...
        i.btCleanup = function(){
          ...
          avt_jQuery_1_3_2_ht1.bt.vars.clickAnywhereStack = arrayRemove(avt_jQuery_1_3_2_ht1.bt.vars.clickAnywhereStack, i);
          avt_jQuery_1_3_2_ht1.bt.vars.closeWhenOpenStack = arrayRemove(avt_jQuery_1_3_2_ht1.bt.vars.closeWhenOpenStack, i);
    ...
    if (typeof opts.trigger == 'string') {
      ...
      if (opts.trigger[0] == 'hoverIntent') {
        var hoverOpts = avt_jQuery_1_3_2_ht1.extend(opts.hoverIntentOpts, {
          over: function() {
            this.btOn();
          },
          out: function() {
  ...
  }; // </ avt_jQuery_1_3_2_ht1.fn.bt() >
  
  /**
   * avt_jQuery_1_3_2_ht1's compat.js (used in Drupal's avt_jQuery_1_3_2_ht1 upgrade module, overrides the $().position() function
   *  this is a copy of that function to allow the plugin to work when compat.js is present
   *  once compat.js is fixed to not override existing functions, this function can be removed
   *  and .btPosion() can be replaced with .position() above...
   */
  avt_jQuery_1_3_2_ht1.fn.btPosition = function() {
    ...
    return results;
  }; // </ avt_jQuery_1_3_2_ht1.fn.btPosition() >
  
  
  /**
  * avt_jQuery_1_3_2_ht1's dimensions.js overrides the $().btOuterWidth() function
  *  this is a copy of original avt_jQuery_1_3_2_ht1's outerWidth() function to 
  *  allow the plugin to work when dimensions.js is present
  */
  avt_jQuery_1_3_2_ht1.fn.btOuterWidth = function(margin) {
  ...
  }; // </ avt_jQuery_1_3_2_ht1.fn.btOuterWidth() >
  
  /**
   * A convenience function to run btOn() (if available)
   * for each selected item
   */
  avt_jQuery_1_3_2_ht1.fn.btOn = function() {
    return this.each(function(index){
      if (avt_jQuery_1_3_2_ht1.isFunction(this.btOn)) {
        this.btOn();
      }
    });
  }; // </ $().btOn() >
   ...
   * for each selected item
   */
  avt_jQuery_1_3_2_ht1.fn.btOff = function() {
    return this.each(function(index){
      if (avt_jQuery_1_3_2_ht1.isFunction(this.btOff)) {
        this.btOff();
      }
    });
  }; // </ $().btOff() >
  
  avt_jQuery_1_3_2_ht1.bt.vars = {clickAnywhereStack: [], closeWhenOpenStack: []};
  
  /**
   * This function gets bound to the document's click event
   * It turns off all of the tips in the click-anywhere-to-close stack
   */
  avt_jQuery_1_3_2_ht1.bt.docClick = function(e) {
    if (!e) {
      var e = window.event;
    };
    // if clicked element is a child of neither a tip NOR a target
    // and there are tips in the stack
    if (!$(e.target).parents().andSelf().filter('.bt-wrapper, .bt-active').length && avt_jQuery_1_3_2_ht1.bt.vars.clickAnywhereStack.length) {
      // if clicked element isn't inside tip, close tips in stack
      $(avt_jQuery_1_3_2_ht1.bt.vars.clickAnywhereStack).btOff();
      $(document).unbind('click', avt_jQuery_1_3_2_ht1.bt.docClick);
    }
  }; // </ docClick() >
   ...
   *
   *   avt_jQuery_1_3_2_ht1.bt.options.width = 400;
   *
   * Be sure to use *avt_jQuery_1_3_2_ht1.bt.options* and not avt_jQuery_1_3_2_ht1.bt.defaults when overriding
   *
   ...
   *
   */
  avt_jQuery_1_3_2_ht1.bt.defaults = {
    ...
    ajaxPath:         null,                  // if using ajax request for content, this contains url and (opt) selector
                                             ...
                                             // examples (see avt_jQuery_1_3_2_ht1 load() function):
                                             //   '/demo.html'
                                             //   '/help/ajax/snip'
                                             //   '/help/existing/full div#content'
                                             
                                             // ajaxPath can also be defined as an array
                                             // in which case, the first value will be parsed as a avt_jQuery_1_3_2_ht1 selector
    ...
    ajaxOpts:         {},                    // any other ajax options - timeout, passwords, processing functions, etc...
                                             // see http://docs.avt_jQuery_1_3_2_ht1.com/Ajax/avt_jQuery_1_3_2_ht1.ajax#options
    ...
    hoverIntentOpts:  {                          // options for hoverIntent (if installed)
                        interval: 300,           // http://cherne.net/brian/resources/avt_jQuery_1_3_2_ht1.hoverIntent.html
                        timeout: 500
                      },
    offsetX         : 0,
    offsetY         : 0
  ...
  avt_jQuery_1_3_2_ht1.bt.options = {};
